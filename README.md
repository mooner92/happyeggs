...
**문서화 시작** 2026-07-07 · **현재 단계** ✅ M6 Implemented + 디자인 v3(2026-07-09, [ADR-0013](docs/adr/0013-humor-theme-charkit.md)) — 유머러스 테마 확정, charKit(외곽선·2톤·글린트 눈), 손님 8,640 조합 + 적 7종·손/팬/소품 전면 리디자인. 남은 게이트: 디렉터 폰 실측 → M6 Verified, M7은 별도 승인.
...
| M5 | 야간 + 스킨 | 열화상 표현, 불 끄기 적+가짜불 스티커, 스킨 상점(구매·장착 저장 v3) | ✅ Verified |
| M6 | 폴리시 | 절차적 SFX 19키, 게임필(비행·파편·반동), 밸런스 시트, 성능(번들 336KB gz) | 🔶 Implemented (폰 실측 대기) |

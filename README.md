...
**문서화 시작** 2026-07-07 · **현재 단계** ✅ M5 Verified + M6 Implemented(2026-07-09) — 절차적 SFX 19키·게임필(서빙 비행·껍데기 파편·착지 반동)·밸런스 시트. **남은 게이트: 디렉터 폰 실측 60fps → M6 Verified**, 이후 M7(앱/스팀)은 별도 승인.
